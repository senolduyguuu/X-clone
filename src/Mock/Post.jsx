export const posts = [
	{
		...
		type: 'poll',
		content: `Antalya'da bir kadın yaptığı kredi kartı harcamasını eşine söylemekten korktuğu için Oscarlık senaryo yazdı.
• Evi dağıtıp role giren kadın eve hırsız girdiğini, 1.5 yaşındaki çocuğu kaçırmakla tehdit edip altınların yerini öğrendiğini ve evi soyduğunu söyleyerek polis çağırdı.`,
		poll: {
			voted: false,
			votes: 12,
			answers: [
		...
		account: {
			avatar: 'https://pbs.twimg.com/profile_images/1661372433142624257/ZSJRRfb2_bigger.jpg',
			username: '@bosunatiklama',
			fullName: 'Boşuna Tıklama'
		},
		stats: {
			comments: 43535,
			repost: 3434,
	...
	},
	{
		...
		account: {
			avatar: 'https://pbs.twimg.com/profile_images/1594177852697714694/ql_Tgnog_bigger.jpg',
			username: '@mattfigdore',
			fullName: 'Matt Figdore',
			verified: true
		},
		stats: {
			comments: 43535,
