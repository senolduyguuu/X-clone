...
export default function Footer() {
	return (
		<footer className="mb-4 px-4 flex flex-wrap gap-2 text-[0.813rem]">
			<Link to="/" className="text-[#71767b] leading-4 hover:underline">Hizmet Şartları</Link>
			<Link to="/" className=" text-[#71767b]  leading-4 hover:underline">Gizlilik Politikası</Link>
			<Link to="/" className="text-[#71767b]  leading-4 hover:underline">Çerez Politikası</Link>
			<Link to="/" className="text-[#71767b]  leading-4 hover:underline">Imprint</Link>
			<Link to="/" className="text-[#71767b]  leading-4 hover:underline">Erişilebilirlik</Link>
			<Link to="/" className="text-[#71767b]  leading-4 hover:underline">Reklam bilgisi</Link>
			<div className="inline-flex gap-2 flex-wrap">
				<Popover className="relative inline-flex leading-4">
					...
					<Popover.Panel className="w-[9.375rem] max-w-[24rem] bg-black shadow-box rounded-xl absolute bottom-0 right-0 grid overflow-hidden">
						<Link to="/" className="py-3 px-4 leading-5 font-bold hover:bg-black transition-colors">
							Hakkında
						</Link>
						<Link to="/" className="py-3 px-4 leading-5 font-bold hover:bg-black transition-colors">
							Durum
