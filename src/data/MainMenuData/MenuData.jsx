// const states = store.getState().auth.currentAccounts.name
import { store } from "../../store"
const profileStates = store.getState().Auth.currentAccounts.name
const mainMenu = [
	{
		path: '/',
		title: 'Anasayfa',
	...
	},
	{
		...
		icon: {
			active: (
				...
				<svg viewBox="0 0 24 24" className="h-[1.641rem]" ><g><path fill="currentColor"
